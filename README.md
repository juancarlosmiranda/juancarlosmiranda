...
| ![AK_SM_RECORDER_100](https://github.com/juancarlosmiranda/juancarlosmiranda/blob/main/images/ak_sm_recorder_992.png?raw=true) | AK_SM_RECORDER - Azure Kinect Standalone Mode ([https://github.com/GRAP-UdL-AT/ak_sm_recorder](https://github.com/GRAP-UdL-AT/ak_sm_recorder)) | A simple GUI recorder based on Python to manage Azure Kinect camera devices in a standalone mode. ([https://pypi.org/project/ak-sm-recorder/](https://pypi.org/project/ak-sm-recorder/)) |
